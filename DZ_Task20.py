...
letters_eng = {1:'AEIOULNSTR', 2:'DG', 3:'BCMP', 4:'FHVWY', 5:'K', 8:'JZ',10:'QZ'}
letters_rus = {1:'АВЕИНОРСТ', 2:'ДКЛМПУ',3:'БГЁЬЯ', 4:'ЙЫ', 5:'ЖЗХЦЧ', 8:'ШЭЮ', 10:'ФЩЪ'}
text = input().upper()
if isCyrillic(text):
	print(sum([a for i in text for a, b in letters_rus.items() if i in b]))
else:
	print(sum([a for i in text for a, b in letters_eng.items() if i in b]))
